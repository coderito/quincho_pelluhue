        ...
        <div className="md:px-10 flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="https://flowbite.com/" className="flex items-center">
            <img
              ...
              className="h-14 md:h-20 mr-3 bg-white rounded-full"
              alt="Flowbite Logo"
            />
          ...
          <button
            ...
            type="button"
            onClick={handleMenu}
            className="inline-flex items-center p-2 ml-3 text-md text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 "
